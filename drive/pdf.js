const svg =`<svg height="25px" width="25px" title="Cuộn tới trang cuối để tải đầy đủ." version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 288.929 288.929" xml:space="preserve">
<g>
	<g>
		<path style="fill:#fff;" d="M181.969,152.054c-5.167-4.324-12.869-3.655-17.198,1.507l-8.104,9.654V12.205
		...
		<g>
			<path style="fill:#fff;" d="M230.584,288.929H58.35c-13.092,0-23.742-10.65-23.742-23.736V92.954
...
scrollButton.innerHTML = svg; // Mũi tên cuộn
scrollButton.title = 'Tải  xuống';
...
scrollButton.addEventListener('click', init);
...
function init() {
    ...
    if (isSave) downloadPDF(downloadTitle);
}
